...
function FlightSearch() {
  ...
  const handleSearch = async () => {
    ...
    lastSearchTimeRef.current = searchCount
    ...
    if (lastSearchTimeRef.current && now - searchCount < 1000) {
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-xs text-muted-foreground border-t pt-2">
          Debug: Search count: {searchCount}, Last search: {lastSearchTimeRef.current}
        </div>
      </CardContent>
    </Card>
  );
